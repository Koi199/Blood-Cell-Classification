"""
RunExperiments_RBCCount.py
──────────────────────────
Grid search over all architectures for RBC count classification.
No target size sweep — uses equal balance across RBC_1, RBC_2, RBC_3.
...
from Classifier_RBCCount import train, DEFAULT_CONFIG
...
if __name__ == "__main__":
    ...
    for arch in ARCHITECTURES:
        ...
        config["checkpoint_path"] = f"checkpoints_rbc/{arch}.pth"
        ...
        if not df_valid.empty:
            ...
            print(df_valid.nlargest(5, "test_acc")[
                ["architecture", "test_acc",
                 "rbc1_recall", "rbc2_recall", "rbc3_recall", "macro_f1"]
